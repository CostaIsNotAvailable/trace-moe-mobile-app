...
public class MultipartRequest extends Request<NetworkResponse> {
    ...
    public MultipartRequest(int method, String url, Response.Listener<NetworkResponse> _responseListener, Response.ErrorListener _responseErrorListener) {
        super(method, url, _responseErrorListener);
